    ...
    Highcharts.wrap(Highcharts.Point.prototype, 'select', function (proceed) {
      ...
      if (points.length) {
        if (points.length === 1) {
          ...
          document.querySelector('#info1 h2').innerHTML = points[0].name;
        } else {
        ...
        document.querySelector('#info1 .subheader')
          .innerHTML = '<h4>Historical Crime</h4><small><em>Shift + Click on map to compare countries</em></small>';
        ...
        tooltip: {
          formatter: function () {
            return '<br>NPU: ' +this.point.npu + (
              ...
              '<br> Year: ' + this.point.occur_year+'<br>Number of crime: ' + this.point.crime_count  : ''
            );
          }
        },
